...
const tabs = [
  {
    ...
    images: [
      { title: "Board", picture: "/assets/Board.svg" },
      { title: "Table", picture: "/assets/Notes.svg" },
      { title: "Goal", picture: "/assets/goal.svg" },
      { title: "AI", picture: "/assets/ai.svg" },
      { title: "Note", picture: "/assets/notes.svg" },
      { title: "List", picture: "/assets/list.svg" },
    ],
      ...
      <div className="flex flex-col  pt-20 xl:py-32 items-center justify-center">
        ...
        <div className="items-center flex justify-center flex-col">
          ...
          <div className="m text-center">
            <div className="text-sm  font-medium pt-4">Suraj</div>
            <div className="text-sm">Developer, Loading...</div>
          </div>
        </div>
      </div>
    </>
