...
import animationData from "../../public/assets/front.json";
...
const tabs = [
  ...
  },
  {
    ...
    image: "/assets/knowledge-rafiki.svg",
  },

  {
    ...
    image: "/assets/projections-pana.svg",
  },
  {
    icon: (
...
const HeroSection = () => {
  ...
  return (
    <div className="md:items-center bg-[#E8E8E8]  flex flex-col ">
      <div
        className="
        ...
        <Link href="/">
          <Button className="py-1 ">
            <div className="flex items-center group justify-center">
              ...
              <div>
                <PiArrowRight className="ml-2 group-hover:translate-x-1 " />
              </div>
            </div>
          </Button>
        </Link>
